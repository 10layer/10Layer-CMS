...
$autoload['packages'] = array(APPPATH.'third_party/10layer');
...
$autoload['helper'] = array('url','string','javascript',"blurb");
...
$autoload['model'] = array('model_content','model_user','model_workflow');
