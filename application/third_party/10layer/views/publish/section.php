...
<!-- ===================================== -->
	...
	<div id="search">
		...
		?>
			<select style="padding-left:3px;float:left;margin-top:2px;border: 1px solid #757474;height:22px;" type="text" id="publish_section_filter">
		
			<option value=''> filter by subsection... </option>
		<?php
